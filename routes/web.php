    ...
    'middleware' => [ 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath','localize','setLang']], function()
{
    ...
    Route::get(LaravelLocalization::transRoute('routes.center-create'), 'CenterController@create')->name('center.create')->middleware('role:admin');
    ...
    Route::get(LaravelLocalization::transRoute('routes.equipment-create'), 'EquipmentController@create')->name('equipment-create')->middleware('role:admin');
    ...
    Route::post('components', 'ComponentController@store')->middleware('role:admin');
    Route::delete('components/{id}', 'ComponentController@destroy')->middleware('role:admin');
    Route::put('components/{id}', 'ComponentController@update')->middleware('role:admin');
